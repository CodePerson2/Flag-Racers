...
describe('Obstacles', function(){
	...
	it ('should block movement of car when car hits coup', function(done){
...
describe('Boosts', function(){
	...
	it ('should increase car speed when it hits oil', function(done){
	...
	it ('should Terminate game immediately', function(done){
